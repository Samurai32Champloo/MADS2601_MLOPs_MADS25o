...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{src/abbildungen/end-to_end_architecture.png}
	\caption{End-to-end MLOps Architektur und workflow mit funktionalen Komponenten and Rollen \cite{kreuzberger2023}}
	\label{fig:end_to_end_architecture}	
\end{figure}

Aufbauend auf diesen Überlegungen zeigt die generalisierte MLOps End-to-End Architektur in Abbildung \ref{fig:end_to_end_architecture} den gesamten Ablauf vom Start eines MLOps-Produkts bis zur Modell Bereitstellung \cite{kreuzberger2023}.
